...
$sql = "SELECT * FROM prod WHERE kategorija = 'suha'";
...
<body>
    ...
    <div class="akne"><a href="akne.php">AKNE</a></div>
      <div class="bore"><a href="bore.php">BORE</a></div>
      <div class="suha-koza"><a href="masna-koza.php">MASNA KOŽA</a></div>
  </div>

        <div class="proizvodi">
            <div class="naslov">SUHA KOŽA</div>
            <div class="sadrzaj">
                <?php
